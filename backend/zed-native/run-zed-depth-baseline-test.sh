...
# Reproducible depth-only benchmark. This enables ZED PERFORMANCE depth but no
# neural object detection and leaves the encoded output identical to production.
