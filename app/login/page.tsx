    ...
    <>
      <main className='absolute top-0 h-screen w-screen p-2 flex items-center justify-center gap-8'>
        ...
        <div className="card gap-2 shadow-2xl border-base-content/10 border max-w-sm w-full bg-base-200 p-6">
          ...
          <button disabled={isLoading} className={`btn btn-primary btn-soft justify-between my-2`} onClick={() => { void signIn("google", { redirectTo: "/signup", }); setIsLoading(true); }}>
            <div className="flex items-center gap-1">
              ...
              <p>{isLoading ? "Connecting..." : "Continue with Google"}</p>
            </div>
